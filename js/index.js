...
const API_KEY = 'WrRZQTmXRn-h73HYFi8qhw';
/**
 ...
 */
const API_SECRET = 'Jzi8q1VrjrPOSzpVFDN8wKNpZB4xKUgcGcob';

testTool = window.testTool;
document.getElementById('display_name').value = `Local${
...
document.getElementById('clear_all').addEventListener('click', (e) => {
    ...
    window.location.href = '../view/table-room/meeting_room2.php';
});
...
document.getElementById('join_meeting').addEventListener('click', (e) => {
    ...
    const signature = ZoomMtg.generateSignature({
        ...
        success(res) {
            ...
            const joinUrl = `../view/table-room/meeting.php?${testTool.serialize(meetingConfig)}`;
            console.log(joinUrl);
...
window.copyJoinLink = function (element) {
    ...
    const signature = ZoomMtg.generateSignature({
        ...
        success(res) {
            ...
            meetingConfig.signature = res.result;
            meetingConfig.apiKey = API_KEY;
            const joinUrl = `${testTool.getCurrentDomain()
            }../view/table-room/meeting.php?${

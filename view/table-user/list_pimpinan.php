...
<head>
  ...
  <title>List User Pimpinan</title>
...
$result = mysqli_query($mysqli, "SELECT * FROM user WHERE Level ='Pimpinan' ORDER BY id ASC");
?>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <div class="row">
                  <div class="col">          
                    <h3 class="card-title">List Room</h3></div>
                  <div class="col">
                    
                    <a href="../dashboard/halaman_user.php"class="btn btn-warning float-right mx-2"><i class="fas fa-arrow-left"></i>  Back</a>
                    <a href="create_user.php"class="btn btn-success float-right"><i class="fas fa-plus-circle"></i>  Add New Room</a>
                  </div>
                </div>
              </div>
              <!-- /.card-header -->

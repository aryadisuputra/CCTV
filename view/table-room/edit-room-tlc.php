...
<body class="hold-transition dark-mode sidebar-mini">
	...
	<?php
		...
		{	
			...
			// update user data
			$result = mysqli_query($mysqli, "UPDATE list_room_tlc SET name='$name',tl_name='$tl_name' WHERE id=$id");
			if($result){
				header("Location: table-ch-kra.php?notif=2");
			}else{
				header("Location: table-ch-kra.php?notif=4");
			}
	...
	<?php
		...
		$result = mysqli_query($mysqli, "SELECT * FROM list_room_tlc WHERE id=$id");
			...
			<section class="content">
				<div class="container-fluid">
					<div class="card card">
						...
						<!-- /.card-header -->
						<!-- form start -->
						<form name="update_user" method="post" action="edit-room-tlc.php">
							<div class="card-body">
